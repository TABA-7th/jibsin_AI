                ...
                },
                {
                    ...
                    "content": [
                        ...
                        "text": (
                            ...
                            f"- 채권최고액은 '(소유권 이외의 권리에 관한 사항)' 이후에 나오는 모든 금액을 식별한다."
                            f"- 채권최고액은 여러개일 확률이 높으므로 모두 검출하되, 가장 최근(순위번호가 가장 큰) 것만 실제 바운딩박스로 지정한다."
                            f"- 다른 채권최고액은 text 내용은 유지하되 좌표를 0,0,0,0으로 설정한다."
